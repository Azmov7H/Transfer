                ...
                <form onSubmit={handleSubmit} className="space-y-6 pt-4">
                    <div className="p-5 rounded-2xl bg-primary/5 border border-primary/10 space-y-3 shadow-sm">
                        ...
                        <div className="pt-3 border-t border-primary/10">
                            ...
                            <div className="text-3xl font-black tracking-tighter text-destructive flex items-baseline gap-1">
                    ...
                    <div className="space-y-2">
                        ...
                        {amount && !isNaN(amount) && (
                            <div className="flex justify-between items-center px-2 text-xs font-bold animate-fade-in">
                                ...
                                <span className={cn(
                                    "font-mono",
                                    (totalBalance - parseFloat(amount)) > 0 ? "text-destructive" : "text-success"
                                )}>
